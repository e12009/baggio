 ...
 */
public class QemuHook extends AbstractHook {
    private static final String TAG = "QemuHook";

    public QemuHook(XC_LoadPackage.LoadPackageParam loadPackageParam) {
        ...
        try {
            XposedHelpers.findAndHookMethod(File.class, "exists", new FileExistsFaker() {
                ...
                protected MethodHookParam fakeParams(MethodHookParam param) {
                    ...
                    String regex = "/dev/qemu_pipe|/dev/socket/qemud" +
